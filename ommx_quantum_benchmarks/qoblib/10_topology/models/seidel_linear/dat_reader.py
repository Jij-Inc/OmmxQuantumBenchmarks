...
def load_topology_instance(instance_path: str | Path) -> dict[str, object]:
    ...
    # Add default bounds for diameter (as used in the ZPL file)
    # This is also justified by the actual lp files.
    # See https://git.zib.de/qopt/qoblib-quantum-optimization-benchmarking-library/-/blob/main/10-topology/models/seidel_linear/lp_files.tar.gz?ref_type=heads.
    min_diameter = 0
    max_diameter = nodes
